...
public class Operator {
    ...
    // Getters para datos
    public String getId() { return operatorId; }
    ...
    public Iterator<Task> getAssignedTasks() { return this.assignedTasks.values(); }
    public Iterator<Task> getAcceptedTasks() { return this.acceptedTasks.values(); }
    public Iterator<Task> getCompletedTasks() { return this.completedTasks.values(); }
    public Iterator<Task> getRejectedTasks() { return this.rejectedTasks.values(); }

    // Getters para tamaños (para los métodos num...Tasks y getOperator...Most)
    public int numAssignedTasks() { return this.assignedTasks.size(); }
    public int numAcceptedTasks() { return this.acceptedTasks.size(); }
    public int numCompletedTasks() { return this.completedTasks.size(); }
    public int numRejectedTasks() { return this.rejectedTasks.size(); }
}